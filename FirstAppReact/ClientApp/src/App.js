...
const App = () =>
{
  ...
  const cerrarTarea = async (id) => {//[Route("Cerrar/{id:int}")]
      ...
      <div className="col-sm-12">
        <form onSubmit={guardarTarea}>
          <div className="input-group">
            <input type="text" className="form-control" placeholder="Ingrese la descripcion de la tarea" value={descripcion} onChange={(e) => setDescripcion(e.target.value)}></input>
              ...
              (
                <div key={item.idTarea} className="list-group-item list-group-item-action">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <button className="btn btn-sm btn-outline-dane" onClick={() => cerrarTarea(item.idTarea)}>Cerrar</button>
                  </div>
                </div>
              )
            )
